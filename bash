...
snakemake   train_features_2_vec      -call --config root=polblog_one gnn_model=gcn env=local device=cuda:0 r2v=false crosswalk=false fairwalk=true node2vec=false dataset=polblog  --nolock --ignore-incomplete;
...
snakemake   train_features_2_vec      -call --config root=polblog_one gnn_model=gcn env=local device=cuda:0 r2v=false crosswalk=false fairwalk=true node2vec=true dataset=polblog  --nolock --ignore-incomplete;
...
snakemake   train_features_2_vec      -call --config root=polblog_one gnn_model=gcn env=local device=cuda:0 r2v=false crosswalk=true fairwalk=false node2vec=false dataset=polblog  --nolock --ignore-incomplete;
...
snakemake   train_features_2_vec      -call --config root=polblog_one gnn_model=gcn env=local device=cuda:0 r2v=false crosswalk=true fairwalk=false node2vec=true dataset=polblog  --nolock --ignore-incomplete;
