...
rule train_gnn:
    ...
    run:
        ...
        if not DISABLE_WANDB:
            wandb.init(project=DATASET + '_improved',name="DATA_ROOT={}_MODEL={}_CROSSWALK={}_FAIRWALK={}_NODE2VEC={}_R2V={}".format(DATA_ROOT, GNN_MODEL, CROSSWALK, FAIRWALK, NODE2VEC, R2V))
